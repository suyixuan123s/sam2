...
if __name__ == '__main__':
    video_file = "/home/suyixuan/AI/Pose_Estimation/sam2/data/DATA0417/o10/video/o10.mp4"  # 替换为你的视频文件路径
    output_directory = "/home/suyixuan/AI/Pose_Estimation/sam2/data/DATA0417/o10/output_frames"  # 替换为你想要保存帧图像的目录
