...
# 读取视频文件
cap = cv2.VideoCapture('/home/suyixuan/AI/Pose_Estimation/sam2/data/vidoe_data/10ml_metal_rack.mp4')
...
# 函数：保存掩码到文件
def save_mask_to_file_blackwhite(frame_idx, masks, output_dir="/home/suyixuan/AI/Pose_Estimation/sam2/data/out_data/10ml_metal_rack/output_masks12"):
...
def save_highlighted_mask(frame, masks, output_dir="/home/suyixuan/AI/Pose_Estimation/sam2/data/out_data/10ml_metal_rack/output_masks121", frame_idx=0, threshold=0.5, color=(128, 0, 128),
                          alpha=0.5):
    os.makedirs(output_dir, exist_ok=True)
    mask_np = masks.squeeze().cpu().numpy()
    highlighted_frame = frame.copy()
